    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Permitir todos los actuator (Prometheus, Health, Zipkin)
                      //  .requestMatchers("/actuator/**").permitAll()
                       // .requestMatchers(EndpointRequest.toAnyEndpoint()).permitAll()
                        ...
                        // Endpoints de órdenes: Solo usuarios autenticados pueden operar
                        .requestMatchers(HttpMethod.POST, "/api/orders").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/orders/**").authenticated()

                        // Si en el futuro agregas borrar pedidos, podrías restringirlo a ADMIN
                ...
                // Manejo de errores con respuestas JSON (Excelente práctica)
